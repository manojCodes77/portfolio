...
const techStack :TechStackData = {
  "Web Development": [
    ...
    {
      name :"Hono",
      icon:"https://hono.dev/images/logo-small.png"
    },
  ...
  Others: [
    ...
    {
      name:"Cloudflare",
      icon:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Cloudflare_Logo.svg/330px-Cloudflare_Logo.svg.png"
    }
  ],
};
    ...
    <section className="py-16 px-6 lg:px-24 bg-gray-50">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {Object.keys(techStack).map((category) => (
            <button
              ...
              className={`px-6 py-3 rounded-full text-sm lg:text-base font-semibold transition-all duration-300 shadow-md focus:outline-none ${
      ...
      <div className="lg:w-3/4 2xl:w-3/5 mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-6 sm:gap-8">
        {techStack[selectedCategory]?.map((tech) => (
          <div
            key={tech.name}
            className="flex flex-col items-center space-y-4 p-4 bg-white rounded-xl shadow-lg transform transition-transform duration-300 hover:scale-105"
          >
            <div className="bg-gray-100 rounded-full p-6 object-cover">
